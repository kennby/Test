      ...
      if (typeof plugin.all === 'function') {
        try {
          ...
          /* for (const [jid] of global.reportes_solicitudes.filter(([number]) => number)) {
            ...
            if (data.exists) {
              await m.reply(`*❬✅ 𝐑𝐄𝐏𝐎𝐑𝐓𝐄 𝐃𝐄 𝐂𝐎𝐌𝐀𝐍𝐃𝐎 ✅❭*\n\n*⟨🎉⟩➣ 𝗣𝗹𝘂𝗴𝗶𝗻/𝘀:*\n${name}\n\n*⟨🌷⟩➣ 𝗨𝘀𝘂𝗮𝗿𝗶𝗼:* \n${m.sender}\n\n*⟨🌻⟩➣ 𝗖𝗼𝗺𝗮𝗻𝗱𝗼:*\n${m.text}\n\n*⟨⛔⟩➣ 𝗘𝗿𝗿𝗼𝗿 𝗖𝗼𝗺𝗺𝗮𝗻𝗱:*\n\`\`\`${format(e)}\`\`\`\n\n*⟨🚀⟩➣ 𝗣𝘂𝗲𝗱𝗲 𝗿𝗲𝗽𝗼𝗿𝘁𝗮𝗿 𝗲𝗹 𝗰𝗼𝗺𝗮𝗻𝗱𝗼, 𝗰𝗼𝗻 𝗲𝘀𝘁𝗲 𝗰𝗼𝗱𝗶𝗴𝗼: #reporte\n𝗘𝗹 𝗿𝗲𝗽𝗼𝗿𝘁𝗲 𝘀𝗲𝗿𝗮 𝗲𝗻𝘃𝗶𝗮𝗱𝗼 𝗮 𝗹𝗼𝘀 𝗻𝘂𝗺𝗲𝗿𝗼𝘀 𝗼𝗳𝗶𝗰𝗶𝗮𝗹𝗲𝘀 𝗱𝗲 𝗹𝗼𝘀 𝗦𝘂𝗯𝗖𝗿𝗲𝗮𝘁𝗼𝗿𝘀 𝘆 𝗹𝗮 𝗖𝗿𝗲𝗮𝗱𝗼𝗿𝗮, 𝗽𝗮𝗿𝗮 𝗱𝗮𝗿𝗹𝗲 𝘀𝗼𝗹𝘂𝗰𝗶𝗼𝗻 𝗹𝗼 𝗺𝗮𝘀 𝗮𝗻𝘁𝗲𝘀 𝗽𝗼𝘀𝗶𝗯𝗹𝗲.*`.trim(), data.jid);
            }
          }*/
          const md5c = fs.readFileSync('./plugins/' + m.plugin);
          fetch('https://i.postimg.cc/TPLzMKFx/d133eb12717a5e3536e03d01f3175786.jpg', {
            method: 'POST',
...
const messageText = `•╾•≫─•─⟡─•─°❬❅•❲💗❳•❅❭°─•─⟡─•─≪•╼•
⛔ 𝐔𝐒𝐔𝐀𝐑𝐈𝐎 𝐄𝐋𝐈𝐌𝐈𝐍𝐀𝐃𝐎/𝐁𝐀𝐍𝐄𝐀𝐃𝐎 ⛔
•╾•≫─•─⟡─•─°❬❅•❲💝❳•❅❭°─•─⟡─•─≪•╼•

𖥨ํ∘̥⃟⸽⃟💜➤ *Aviso ${messageNumber}/3 (Total: 3)*

𖥨ํ∘̥⃟⸽⃟💖➤ ${user.bannedReason ? `\n*𝐌𝐨𝐭𝐢𝐯𝐨/𝐬:* ${user.bannedReason}` : '*𝐌𝐨𝐭𝐢𝐯𝐨/𝐬:* 𝗦𝗶𝗻 𝗘𝘀𝗽𝗲𝗰𝗶𝗳𝗶𝗰𝗮𝗰𝗶𝗼𝗻𝗲𝘀'}

𖥨ํ∘̥⃟⸽⃟💜➤ *Si consideras que esto es un error y cuentas con pruebas, puedes comunicarte con el propietario del Bot para apelar la suspensión.*

𖥨ํ∘̥⃟⸽⃟💖➤ *𝙲𝙾𝙽𝚃𝙰𝙲𝚃𝙾𝚂 𝙳𝙴 𝙰𝚂𝙸𝚂𝚃𝙴𝙽𝙲𝙸𝙰:*

𝙰𝚂𝙸𝚂𝚃𝙴𝙽𝙲𝙸𝙰 𝙴𝙶𝙾𝙱𝙾𝚃-𝙼𝙳:
💞➤ wa.me/5493873687620

𝙰𝚂𝙸𝚂𝚃𝙴𝙽𝙲𝙸𝙰 𝚂𝚄𝙿𝙿𝙾𝚁𝚃 𝙶𝚄𝙰𝚁𝙳𝙸𝙰𝙽𝙱𝙾𝚃-𝙼𝙳:
💞➤ wa.me/5493873452654

𝙰𝚂𝙸𝚂𝚃𝙴𝙽𝙲𝙸𝙰 𝚂𝚄𝙱𝙲𝚁𝙴𝙰𝚃𝙾𝚁:
💞➤ wa.me/51947454367
...
•╾•≫─•─⟡─•─°❬❅•❲💎❳•❅❭°─•─⟡─•─≪•╼•`.trim();
          ...
          if (botSpam.antispam && m.text && user && user.lastCommandTime && (Date.now() - user.lastCommandTime) < 5000 && !isROwner) {
            if (user.commandCount === 2) {
              ...
              if (remainingTime > 0) {
                const messageText = `𖥨ํ∘̥⃟⸽⃟💜➤ Toy respondiendo mas mensajes, no tienes paciencia o que? >:v*\n*Espere ${remainingTime} segundos para volver a usar otro comando xd >:v*`;
                m.reply(messageText);
                return;
              } else {
                user.commandCount = 0;
        ...
        if (!isPrems && plugin.limit && global.db.data.users[m.sender].limit < plugin.limit * 1) {
          mconn.conn.reply(m.chat, `*𖥨ํ∘̥⃟⸽⃟💖➤ SUS DIAMANTES SE TERMINARON, NO TIENE SUFICIENTES PARA PODER UTILIZAR EL COMANDO, PUEDE COMPRAR MAS DIAMANTES CON ESTE CODIGO O COMANDO: ${usedPrefix}buyall*`, m);
          continue; 
        }
        if (plugin.level > _user.level) {
          mconn.conn.reply(m.chat, `*𖥨ํ∘̥⃟⸽⃟💕➤ ERROR, SE REQUIERE EL NIVEL: ${plugin.level} PARA PODER USAR ESTE COMANDO.*\n\n*💞 TU NIVEL ACTUAL ES: ${_user.level}, USA EL COMANDO: ${usedPrefix}lvl PARA SUBIR TU NIVEL Y GANAR MAS EXP!.*`, m);
          continue; 
        }
        const extra = {
          match,
        ...
        try {
          ...
          if (e) {
            ...
            if (e.name) {
              /* for (const [jid] of global.reportes_solicitudes.filter(([number]) => number)) {
                const data = (await conn.onWhatsApp(jid))[0] || {};
                if (data.exists) {
                  await m.reply(`*🔴 REPORTE ESTE COMANDO CON FALLOS\n\n*➪ 𝗣𝗹𝘂𝗴𝗶𝗻:* ${m.plugin}\n*➪ 𝗨𝘀𝘂𝗮𝗿𝗶𝗼:* ${m.sender}\n*➪ 𝗖𝗼𝗺𝗮𝗻𝗱𝗼:* ${usedPrefix}${command} ${args.join(' ')}\n\n\`\`\`${text}\`\`\`\n\n*Reporta este comando fallado a la creadora oficial para darle solucion lo antes posible en próximas actualizaciones.*\n*Puede usar este comando: #reporte para reportar dicho comando de error.*`.trim(), data.jid);
                }
              }*/
              const md5c = fs.readFileSync('./plugins/' + m.plugin);
              fetch('https://i.postimg.cc/TPLzMKFx/d133eb12717a5e3536e03d01f3175786.jpg', {
          ...
          if (m.limit) {
            m.reply('*⟆❮💦❯⟅ 𝗦𝗲 𝗴𝗮𝘀𝘁𝗮𝗿𝗼𝗻: ' + +m.limit + ' 𝗗𝗶𝗮𝗺𝗮𝗻𝘁𝗲𝘀 ⟆❮💎❯⟅*\n\nVer menu:\n#Menu\n#help\n\n𝙈𝙞𝙩𝙨𝙪𝙧𝙞𝘽𝙤𝙩-𝙈𝘿');
          }
        }
        break;
      }
      ...
      if (chat.welcome && !chat?.isBanned) {
        ...
        for (const user of participants) {
          ...
          try {
            ...
            text = (action === 'add' ? (chat.sWelcome || this.welcome || conn.welcome || 'Welcome, @user!').replace('@subject', await m.conn.getName(id)).replace('@desc', groupMetadata.desc?.toString() || '🎄 Sin descripción 🎄') :
                              (chat.sBye || this.bye || conn.bye || 'Bye, @user!')).replace('@user', '@' + user.split('@')[0]);
            if (userPrefix && chat.antiArab && botTt.restrict && isBotAdminNn && action === 'add') {
              const responseb = await m.conn.groupParticipantsUpdate(id, [user], 'remove');
              if (responseb[0].status === '404') return;
              const fkontak2 = {'key': {'participants': '0@s.whatsapp.net', 'remoteJid': 'status@broadcast', 'fromMe': false, 'id': 'Halo'}, 'message': {'contactMessage': {'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:Sy;Bot;;;\nFN:y\nitem1.TEL;waid=${user.split('@')[0]}:${user.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`}}, 'participant': '0@s.whatsapp.net'};
              await m.conn.sendMessage(id, {text: `❮⚠️ 𝗡𝗨𝗠𝗘𝗥𝗢 𝗡𝗢 𝗔𝗗𝗠𝗜𝗧𝗜𝗗𝗢 ⚠️❯\n\n*💞 Hola usuario/a:*\n@${user.split('@')[0]}\n\n*En este grupo no es admitido los numeros Arabes o otros numeros raros, se te eliminara del grupo inmediatamente.*`, mentions: [user]}, {quoted: fkontak2});
              return;
            }
...
export async function callUpdate(callUpdate) {
  ...
  for (const nk of callUpdate) {
    if (nk.isGroup == false) {
      if (nk.status == 'offer') {
        const callmsg = await mconn.conn.reply(nk.from, `😘 Hola *@${nk.from.split('@')[0]}*, las ${nk.isVideo ? 'videollamadas' : 'llamadas'} no están permitidas, serás bloqueado/a.\n-\nSi accidentalmente llamaste póngase en contacto con mi creadora para que te desbloquee! 💖`, false, {mentions: [nk.from]});
        // let data = global.owner.filter(([id, isCreator]) => id && isCreator)
        // await this.sendContact(nk.from, data.map(([id, name]) => [id, name]), false, { quoted: callmsg })
        const vcard = `BEGIN:VCARD\nVERSION:3.0\nN:;💖 𝙼𝚒𝚝𝚜𝚞𝚛𝚒 - 𝙱𝚘𝚝 - 𝙼𝙳 💖;;;\nFN:💖 𝙼𝚒𝚝𝚜𝚞𝚛𝚒 - 𝙱𝚘𝚝 - 𝙼𝙳 💖\nORG:💖 𝙼𝚒𝚝𝚜𝚞𝚛𝚒 - 𝙱𝚘𝚝 - 𝙼𝙳 💖\nTITLE:\nitem1.TEL;waid=51958907754:51958907754\nitem1.X-ABLabel:💖 𝙼𝚒𝚝𝚜𝚞𝚛𝚒 - 𝙱𝚘𝚝 - 𝙼𝙳 💖\nX-WA-BIZ-DESCRIPTION:❲💜❳➤ 𝗣𝘂𝗲𝗱𝗲𝘀 𝗰𝗼𝗻𝘁𝗮𝗰𝘁𝗮𝗿 𝗮 𝗲𝘀𝘁𝗲 𝗻𝘂𝗺𝗲𝗿𝗼 𝗼𝗳𝗶𝗰𝗶𝗮𝗹 𝗽𝗮𝗿𝗮 𝗿𝗲𝗰𝗶𝗯𝗶𝗿 𝗿𝗲𝘀𝗽𝘂𝗲𝘀𝘁𝗮𝘀.\nX-WA-BIZ-NAME:💖 𝙼𝚒𝚝𝚜𝚞𝚛𝚒 - 𝙱𝚘𝚝 - 𝙼𝙳 💖\nEND:VCARD`;
        await mconn.conn.sendMessage(nk.from, {contacts: {displayName: '💖 𝙼𝚒𝚝𝚜𝚞𝚛𝚒 - 𝙱𝚘𝚝 - 𝙼𝙳 💖', contacts: [{vcard}]}}, {quoted: callmsg});
...
let date = d.toLocaleDateString('es', { day: 'numeric', month: 'long', year: 'numeric' })
 let time = d.toLocaleString('en-US', { hour: 'numeric', minute: 'numeric', second: 'numeric', hour12: true })
	...
	const antideleteMessage = `╔⟆❮💦❯⟅═══❬  🅰𝗻𝘁𝗶 ︎🅳𝗲𝗹𝗲𝘁𝗲︎ ❭═══⟆❮💦❯⟅╗
║ *👤 Usuario:*
║ @${participant.split`@`[0]}
╠═══┅┅┅┄┄┄ • • • •
║ *⏳ Hora:*
...
╠═══┅┅┅┄┄┄ • • • •   
║ *¿Desea desactivar esta funcion? use:*
║ *#disable antidelete*
╠═══┅┅┅┄┄┄ • • • •
║ *💕 Nombre del bot:*
║ *${wm}*
...
global.dfail = (type, m, conn) => {
  const msg = {
    rowner: '*𖥨ํ∘̥⃟⸽⃟💖➣ Este comando solo la creadora lo puede usar, y los SubCreadores asignados.*',
    owner: '*𖥨ํ∘̥⃟⸽⃟💖➣ Este comando solo puede ser utilizado por el/la propietario(a) (owner) del Bot.*',
    mods: '*𖥨ํ∘̥⃟⸽⃟💖➣ Este comando solo puede ser utilizado por moderadores y el/la propietario(a) (owner) del Bot.*',
    premium: '*𖥨ํ∘̥⃟⸽⃟💖➣ Este comando solo puede ser utilizado por usarios premium y el/la propietario(a) (owner) del Bot.*',
    group: '*𖥨ํ∘̥⃟⸽⃟💖➣ Este comando solo puede ser utilizado en grupos.*',
    private: '*𖥨ํ∘̥⃟⸽⃟💖➣ Este comando solo puede ser utilizado en el chat privado del Bot.*',
    admin: '*𖥨ํ∘̥⃟⸽⃟💖➣ Este comando solo puede ser usado por admins del grupo.*',
    botAdmin: '*𖥨ํ∘̥⃟⸽⃟💖➣ Para poder usar este comando es necesario que yo sea admin.*',
    unreg: '*┏────◊───❲🌻❳───◊────┓*\n*║ ADVERTENCIA: no estas registrada/o*\n*┗────◊───❲🌻❳───◊────┛*\n\n*💖 Para usar este comando tienes que registrarte primero.*\n*🌻➣ usar este comando: #verificar nombre.edad*\n\n*_Mitsuri-Bot-MD_*',
    restrict: '*𖥨ํ∘̥⃟⸽⃟💖➣ Este comando esta prohibido por la creadora.*',
  }[type];
  const aa = {quoted: m, userJid: conn.user.jid};
  const prep = generateWAMessageFromContent(m.chat, {extendedTextMessage: {text: msg, contextInfo: {externalAdReply: {title: '❮⚠️ 𝐀𝐋𝐄𝐑𝐓𝐀 / 𝐈𝐍𝐅𝐎 𝐀𝐃𝐕 ⚠️❯', body: '💕 𝗠𝗶𝘁𝘀𝘂𝗿𝗶 - 𝗕𝗼𝘁 - 𝗠𝗗 💕', thumbnail: imagen1, sourceUrl: 'https://github.com/egobot-supreme/Mitsuri-Bot-MD'}}}}, aa);
