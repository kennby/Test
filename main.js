...
console.log(chalk.bold.red(`⛔ No se pudo eliminar algunas cosas durante la eliminación, archivos no eliminados.`))
}}
...
setInterval(async () => {
  ...
  //console.log(chalk.cyanBright(`\n┍┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄•\n┃TMP » Archivos eliminados ✅\n•┕┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄•\n`));
}, 180000);
setInterval(async () => {
  if (stopped === 'close' || !conn || !conn.user) return;
  await purgeSession();
  //console.log(chalk.cyanBright(`\n┍┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄•\n┃PurgeSession » Archivos eliminados ✅\n•┕┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄•\n`));
}, 1000 * 60 * 60);
setInterval(async () => {
  if (stopped === 'close' || !conn || !conn.user) return;
  await purgeSessionSB();
  //console.log(chalk.cyanBright(`\n┍┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄•\n┃SubBotsSession » Archivos eliminados ✅\n•┕┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄•\n`));
}, 1000 * 60 * 60);
setInterval(async () => {
  if (stopped === 'close' || !conn || !conn.user) return;
  await purgeOldFiles();
  //console.log(chalk.cyanBright(`\n┍┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄•\n┃PirgeOldFiles » Archivos eliminados ✅\n•┕┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄┄•\n`));
}, 1000 * 60 * 60);
setInterval(async () => {
  if (stopped === 'close' || !conn || !conn.user) return;
