const handler = async (m, {conn, isPrems}) => {
  ...
  if (new Date - global.db.data.users[m.sender].lastwork < 600000) throw `❬😘❭➤ *Ya aventuraste joven aventurero/a, descanse un poco.\n\n*❬💦❭➤ Para volver a aventurar, regrese en:${msToTime(time - new Date())} ⏱️*`;
  conn.sendMessage(m.chat, {text: `🗻 Sales en una aventura hermosa en 🛤️:*\n\n🌿 *${pickRandom(global.work)}*\n\n*❬🌹❭➤ Ganaste ${hasil} de exp, sigue asi 💦*`}, {quoted: m});
