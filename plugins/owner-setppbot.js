function _0x31ac(_0x16c31d, _0x391554) {
  ...
  const _0x2359c0=_0x31ac; try {
    const _0x2538c6=_0x14ced5[_0x2359c0(0x1c2)][_0x2359c0(0x1b2)]; const _0xf17176=_0x55976e[_0x2359c0(0x1bb)]?_0x55976e['quoted']:_0x55976e; if (!_0x55976e[_0x2359c0(0x1bb)]) throw '*❮🍁❯➤\x20No\x20se\x20encontro\x20la\x20imagen,\x20por\x20favor\x20responde\x20a\x20una\x20imagen\x20usando\x20el\x20comando:\x20'+(_0x33d1e6+_0x480711)+'*'; const _0x353a82=(_0xf17176[_0x2359c0(0x1b1)]||_0xf17176)[_0x2359c0(0x1cf)]||''; const _0x434471=await _0xf17176[_0x2359c0(0x1ba)](); const _0x3aeaf4=await _0x2538c6; async function _0x4d2c5f(_0x2e4ee1) {
  ...
  const _0x1897e4=['AUTO', 'user', '8CJixwu', 'getHeight', 'getBufferAsync', 'w:profile:picture', '*❮😍❯➤\x20Se\x20cambio\x20con\x20exito\x20la\x20foto\x20de\x20perfil\x20del\x20numero\x20del\x20bot ✨*', 'picture', 'read', '1419731ZjYevm', 'MIME_JPEG', '82272azbcaw', '350agtQLJ', '279gQMikZ', 'mimetype', '188728rlRvtO', 'msg', 'jid', 'image', '1705364hxGRFM', '14905ZvBfug', '2578255zmHnCy', 'getWidth', 'reply', '1780230pdlTpE', 'download', 'quoted', 'query', '2810ZHRQDi', 'resize', '*❮⛔❯➤\x20no\x20se\x20encontro\x20la\x20imagen,\x20por\x20favor\x20responde\x20a\x20una\x20imagen\x20usando\x20el\x20comando:\x20', 'rowner']; _0x14c2=function() {
    return _0x1897e4;
  }; return _0x14c2();
}
...
if (!img) throw `*❮⛔❯➤ No se encontro la imagen, por favor responde a una imagen con el comando: ${usedPrefix + command}*`
await conn.updateProfilePicture(bot, img)
conn.reply(m.chat, '*❮😍❯➤ Se cambio la foto de perfil del bot exitosamente.*', m)
} else throw `*❮⛔❯➤ No se encontro la imagen, por favor responde a una imagen con el comando: ${usedPrefix + command}*`}
