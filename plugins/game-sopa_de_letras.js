...
await conn.reply(m.chat, `*@${m.sender.split("@")[0]} 𝐑𝐄𝐆𝐈𝐒𝐓𝐑𝐀𝐃𝐎 𝐄𝐍 𝐄𝐋 𝐉𝐔𝐄𝐆𝐎 💖`, m, { mentions: [m.sender] })
}
...
await conn.reply(m.chat, `*@${tagUser.split("@")[0]} 👑 𝙴𝚂𝚃𝙰 𝙹𝚄𝙶𝙰𝙽𝙳𝙾 𝚂𝙾𝙿𝙰 𝙳𝙴 𝙻𝙴𝚃𝚁𝙰𝚂 𝙰𝙲𝚃𝚄𝙰𝙻𝙼𝙴𝙽𝚃𝙴 𝚄𝚆𝚄*`, m, { mentions: [tagUser] })
return
}
if (intentos === 0) {
intentos = 3  
...
await m.reply(`\`\`\`😘 Has ganado: ${diamante} ${rpgshop.emoticon('limit')}!!\`\`\`\n\n*😍 𝐂𝐎𝐑𝐑𝐄𝐂𝐓𝐎, 𝐋𝐀 𝐏𝐀𝐋𝐀𝐁𝐑𝐀: _"${sopaPalabra}"_ 𝐒𝐄 𝐄𝐍𝐂𝐎𝐍𝐓𝐑𝐀𝐁𝐀 𝐄𝐍 𝐋𝐀 𝐃𝐈𝐑𝐄𝐂𝐂𝐈𝐎𝐍: _${cambioLetra}_ 𝐃𝐄 𝐋𝐀 𝐅𝐈𝐋𝐀: _${fila}_ 𝐘 𝐂𝐎𝐋𝐔𝐌𝐍𝐀: _${columna}_* 😍`)
fila = null, columna = null, sopaNube = null, sopaPalabra = null, sopaDir = null, userSP = null, cambioLetra = null
intentos = 0
return
}else{
...
fila = null, columna = null, sopaNube = null, sopaPalabra = null, sopaDir = null, userSP = null, cambioLetra = null
intentos = 0
await m.reply(`💜 *𝐒𝐄 𝐀𝐂𝐀𝐁𝐀𝐑𝐎𝐍 𝐋𝐎𝐒 𝐈𝐍𝐓𝐄𝐍𝐓𝐎𝐒, 𝐋𝐀 𝐏𝐀𝐋𝐀𝐁𝐑𝐀: _"${sopaPalabra}"_ 𝐒𝐄 𝐄𝐍𝐂𝐎𝐍𝐓𝐑𝐀𝐁𝐀 𝐄𝐍 𝐋𝐀 𝐃𝐈𝐑𝐄𝐂𝐂𝐈𝐎𝐍: _${cambioLetra}_ 𝐃𝐄 𝐋𝐀 𝐅𝐈𝐋𝐀: _${fila}_ 𝐘 𝐂𝐎𝐋𝐔𝐌𝐍𝐀: _${columna}_*`)
return  
} else {
intentos -= 1
await m.reply(`😘 *𝐄𝐒 𝐈𝐍𝐂𝐎𝐑𝐑𝐄𝐂𝐓𝐎, 𝐓𝐄 𝐐𝐔𝐄𝐃𝐀𝐍: _${intentos}_ 𝐈𝐍𝐓𝐄𝐍𝐓𝐎𝐒*${intentos === 1 ? '' : `\n*PALABRA A ENCONTRAR:* \`\`\`${sopaPalabra}\`\`\``}\n\n${intentos === 1 ? `\`\`\`💜 PISTA!!\`\`\`\n*😍 𝐋𝐀 𝐏𝐀𝐋𝐀𝐁𝐑𝐀: _${sopaPalabra}_ 𝐒𝐄 𝐄𝐍𝐂𝐔𝐄𝐍𝐓𝐑𝐀 𝐄𝐍 𝐋𝐀 𝐃𝐈𝐑𝐄𝐂𝐂𝐈𝐎𝐍: _"${cambioLetra}"_*\n\n` : ''}${sopaNube}`)
return
}}
}}
