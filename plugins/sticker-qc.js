...
let text
    if (args.length >= 1) {
        ...
        text = m.quoted.text;
    } else throw "❮🌹❯ 𝗖𝗼𝗺𝗮𝗻𝗱𝗼 𝗺𝗮𝗹 𝘂𝘀𝗮𝗱𝗼, 𝗽𝗼𝗿 𝗳𝗮𝘃𝗼𝗿 𝗮𝗴𝗿𝗲𝗴𝘂𝗲 𝘂𝗻 𝘁𝗲𝘅𝘁𝗼 𝗽𝗮𝗿𝗮 𝘂𝘀𝗮𝗿 𝗲𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼.";
   if (!text) return m.reply('❮🌹❯ 𝗖𝗼𝗺𝗮𝗻𝗱𝗼 𝗺𝗮𝗹 𝘂𝘀𝗮𝗱𝗼, 𝗽𝗼𝗿 𝗳𝗮𝘃𝗼𝗿 𝗮𝗴𝗿𝗲𝗴𝘂𝗲 𝘂𝗻 𝘁𝗲𝘅𝘁𝗼 𝗽𝗮𝗿𝗮 𝘂𝘀𝗮𝗿 𝗲𝘀𝘁𝗲 𝗰𝗼𝗺𝗮𝗻𝗱𝗼.');
    const who = m.mentionedJid && m.mentionedJid[0] ? m.mentionedJid[0] : m.fromMe ? conn.user.jid : m.sender; 
    const mentionRegex = new RegExp(`@${who.split('@')[0].replace(/[.*+?^${}()|[\]\\]/g, '\\$&')}\\s*`, 'g');
    const mishi = text.replace(mentionRegex, '');
   if (mishi.length > 30) return m.reply('*❮💎❯ Jajaja el texto no debe de tener mas de 30 letras.*');
