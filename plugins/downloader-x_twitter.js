...
if (!text) throw `*𖥨ํ∘̥⃟⸽⃟💦➤ 𝗣𝗼𝗿 𝗳𝗮𝘃𝗼𝗿 𝗶𝗻𝗴𝗿𝗲𝘀𝗲 𝘂𝗻 𝗲𝗻𝗹𝗮𝗰𝗲 𝘃𝗮𝗹𝗶𝗱𝗼 𝗱𝗲 𝘁𝘄𝗶𝘁𝘁𝗲𝗿 (𝗫), 𝗽𝗮𝗿𝗮 𝗱𝗲𝘀𝗰𝗮𝗿𝗴𝗮𝗿, 𝗽𝗼𝗿 𝗲𝗷𝗲𝗺𝗽𝗹𝗼: ${usedPrefix + command}* https://twitter.com/auronplay/status/1586487664274206720?s=20&t=3snvkvwGUIez5iWYQAehpw`;
if (enviando) return;
    enviando = true;
try {
 ...
 if (res?.result.type == 'video') {
    ...
    enviando = false;
    throw '*𖥨ํ∘̥⃟⸽⃟⛔➤ 𝗘𝗥𝗥𝗢𝗥 𝗔𝗟 𝗜𝗡𝗧𝗘𝗡𝗧𝗔𝗥 𝗗𝗘𝗦𝗖𝗔𝗥𝗚𝗔𝗥 𝗘𝗟 𝗖𝗢𝗡𝗧𝗘𝗡𝗜𝗗𝗢, 𝗣𝗢𝗥 𝗙𝗔𝗩𝗢𝗥 𝗜𝗡𝗧𝗘𝗡𝗧𝗘 𝗡𝗨𝗘𝗩𝗔𝗠𝗘𝗡𝗧𝗘..*';
    return;
  }
};    
